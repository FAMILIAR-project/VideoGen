...
public class VideoDemonstrator3 {
  private Scanner s;
  ...
  public void tp3_q7() {
    ...
    for (final VideoSeq videoseq : _set) {
      if ((videoseq instanceof MandatoryVideoSeq)) {
        ...
        double _duration = VideoDemonstrator3.getDuration(fileLocation);
        ...
        if ((videoseq instanceof OptionalVideoSeq)) {
          ...
          if ((rand == 0)) {
            ...
            double _duration_1 = VideoDemonstrator3.getDuration(fileLocation_1);
          ...
          double _duration_2 = VideoDemonstrator3.getDuration(fileLocation_2);
    ...
    try {
      final File pl = new File("/home/dania/Documents/IDM/playlist-m3u-etendue.m3u");
  ...
  public String genID() {
    int _plusPlus = VideoDemonstrator3.i++;
