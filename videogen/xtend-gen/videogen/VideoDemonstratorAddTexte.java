...
/**
 * Transformation xtend pour rajouter du texte dans chaque vid�o
 */
...
public class VideoDemonstratorAddTexte {
   ...
   * (Note: on peut jouer sur d'autres param�tres pour cela completer la grammaire xtext puis les param�tres de cette fonction)
   */
