...
public class VideoDemonstrator6 {
  ...
  public void tp3_q11() {
    ...
    for (final VideoSeq videoseq : _set) {
      if ((videoseq instanceof MandatoryVideoSeq)) {
        ...
        if ((StringExtensions.isNullOrEmpty(fileId) || this.vignettesID.contains(fileId))) {
          String _genID = this.genID();
          fileId = _genID;
        } else {
          this.vignettesID.add(fileId);
        }
        ...
        if (_not) {
          ...
          double _duration = VideoDemonstrator6.getDuration(fileLocation);
          mediafile.setDuration(_duration);
          String _vignette = this.vignette;
          String _createVignette = VideoDemonstrator6.createVignette(fileLocation, fileId);
          String _plus = ((("<p>" + fileLocation) + "</p><br/> \n\t\t\t\t\t\t<img src = ") + _createVignette);
          String _plus_1 = (_plus + " width=\'130px\' height=auto id=");
          String _plus_2 = (_plus_1 + fileId);
          String _plus_3 = (_plus_2 + "/><br/>");
          this.vignette = (_vignette + _plus_3);
        ...
        if ((videoseq instanceof OptionalVideoSeq)) {
          ...
          if ((rand == 0)) {
            ...
            if ((StringExtensions.isNullOrEmpty(fileId_1) || this.vignettesID.contains(fileId_1))) {
              String _genID_1 = this.genID();
              fileId_1 = _genID_1;
            } else {
              this.vignettesID.add(fileId_1);
            }
            ...
            if (_not_1) {
              ...
              double _duration_1 = VideoDemonstrator6.getDuration(fileLocation_1);
              mediafile_1.setDuration(_duration_1);
              String _vignette_2 = this.vignette;
              String _createVignette_1 = VideoDemonstrator6.createVignette(fileLocation_1, fileId_1);
              String _plus_4 = ((("<p>" + fileLocation_1) + "</p><br/><img src=") + _createVignette_1);
              String _plus_5 = (_plus_4 + 
                " width=\'130px\' height=auto id=");
              String _plus_6 = (_plus_5 + fileId_1);
              String _plus_7 = (_plus_6 + "/><br/>");
              this.vignette = (_vignette_2 + _plus_7);
          ...
          if ((StringExtensions.isNullOrEmpty(fileId_2) || this.vignettesID.contains(fileId_2))) {
            String _genID_2 = this.genID();
            fileId_2 = _genID_2;
          } else {
            this.vignettesID.add(fileId_2);
          }
          ...
          if (_not_2) {
            ...
            double _duration_2 = VideoDemonstrator6.getDuration(fileLocation_2);
            mediafile_2.setDuration(_duration_2);
            String _vignette_4 = this.vignette;
            String _createVignette_2 = VideoDemonstrator6.createVignette(fileLocation_2, fileId_2);
            String _plus_8 = ((("<p>" + fileLocation_2) + "</p><br/><img src=") + _createVignette_2);
            String _plus_9 = (_plus_8 + 
              " width=\'130px\' height=auto id=");
            String _plus_10 = (_plus_9 + fileId_2);
            String _plus_11 = (_plus_10 + "/><br/>");
            this.vignette = (_vignette_4 + _plus_11);
    ...
    this.generateHtmlFile(this.vignette);
  }
  ...
  private List vignettesID = new ArrayList<String>();
  
  public String genID() {
    int _plusPlus = VideoDemonstrator6.i++;
    return ("vid" + Integer.valueOf(_plusPlus));
  }
  
  public void generateHtmlFile(final String vignette) {
    try {
