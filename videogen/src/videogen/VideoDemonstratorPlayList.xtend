...
//		var play = M3uFactory.eINSTANCE.createPlaylist(); //On cr�e l'objet playlist (le model interm�diaire)	
...
//	}
	...
	//Fonction pour enregistrer dans une playlist interm�diaire les videos du modele videoGen
...
//			}
//		]
//		createScripts(play); //On appelle la m�thode pour cr�er les scripts � partir de la playlist
//	}
	...
	//M�thode pour generer les 3 fichiers avec la playlist (ici on fait le .M3U et ffmpeg)
...
//			println("#EXTINF:"+ getDuration(pathVideo+f.location)) //Appel d'une fonction pour calculer la dur�e d'une vid�o
//			println ("" + f.location + "")
//		}
...
//	}
	...
	//M�thode pour calculer la dur�e d'une vid�o (pour M3U extends)
