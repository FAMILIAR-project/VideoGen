...
class VideoDemostratorConvertToGif {
	...
	/**
	 *transforme une partie de la video en fichier gif de base qualit�
	...
	/**
	 *transforme une partie de la video en fichier gif de haute qualit�
	 * videoLocation = path de la video a utiliser
	...
	def static convertToGifHD(String videoLocation, Integer taille){
		...
		//cree une image .pg qui servira pour la creation du .gif d'haute qualit�
		...
		// commande pour la creation du .gif en utilisant la palette cr�e avant
