...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "IHMJhipster@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "IHMJhipster API";

        private String description = "IHMJhipster API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "IHMJhipster";
