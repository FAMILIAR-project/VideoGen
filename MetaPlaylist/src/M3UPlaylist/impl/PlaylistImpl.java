 ...
 * </p>
 * <ul>
 *   <li>{@link M3UPlaylist.impl.PlaylistImpl#getEntries <em>Entries</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PlaylistImpl extends MinimalEObjectImpl.Container implements Playlist {
	...
	protected EClass eStaticClass() {
		return M3UPlaylistPackage.Literals.PLAYLIST;
	}
	...
	public EList<Entry> getEntries() {
		if (entries == null) {
			entries = new EObjectContainmentEList<Entry>(Entry.class, this, M3UPlaylistPackage.PLAYLIST__ENTRIES);
		}
		return entries;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case M3UPlaylistPackage.PLAYLIST__ENTRIES:
