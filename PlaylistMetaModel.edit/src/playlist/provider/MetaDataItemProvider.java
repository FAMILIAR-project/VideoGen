...
/**
 * This is the item provider adapter for a {@link playlist.MetaData} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MetaDataItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MetaData_duree_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MetaData_duree_feature", "_UI_MetaData_type"),
				 PlaylistPackage.Literals.META_DATA__DUREE,
				 true,
				 false,
				 false,
	...
	protected void addDetailsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MetaData_details_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MetaData_details_feature", "_UI_MetaData_type"),
				 PlaylistPackage.Literals.META_DATA__DETAILS,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_MetaData_type") + " " + metaData.getDuree();
	}
