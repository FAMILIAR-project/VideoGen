...
/**
 * This is the item provider adapter for a {@link playlist.File} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FileItemProvider extends EntryItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PlaylistPackage.Literals.FILE__PATH,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PlaylistPackage.Literals.FILE__METADATA);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(File.class)) {
			case PlaylistPackage.FILE__PATH:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case PlaylistPackage.FILE__METADATA:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PlaylistPackage.Literals.FILE__METADATA,
				 PlaylistFactory.eINSTANCE.createMetaData()));
	}
