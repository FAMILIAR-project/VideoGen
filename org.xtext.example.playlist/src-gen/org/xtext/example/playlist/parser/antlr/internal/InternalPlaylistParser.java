...
public class InternalPlaylistParser extends AbstractInternalAntlrParser {
    ...
    // InternalPlaylist.g:107:1: ruleVideo returns [EObject current=null] : (otherlv_0= 'file' ( (lv_name_1_0= RULE_STRING ) ) ) ;
    public final EObject ruleVideo() throws RecognitionException {
        ...
        try {
            // InternalPlaylist.g:113:2: ( (otherlv_0= 'file' ( (lv_name_1_0= RULE_STRING ) ) ) )
            // InternalPlaylist.g:114:2: (otherlv_0= 'file' ( (lv_name_1_0= RULE_STRING ) ) )
            {
            // InternalPlaylist.g:114:2: (otherlv_0= 'file' ( (lv_name_1_0= RULE_STRING ) ) )
            // InternalPlaylist.g:115:3: otherlv_0= 'file' ( (lv_name_1_0= RULE_STRING ) )
            {
            otherlv_0=(Token)match(input,11,FOLLOW_4); 

            			newLeafNode(otherlv_0, grammarAccess.getVideoAccess().getFileKeyword_0());
            		
            // InternalPlaylist.g:119:3: ( (lv_name_1_0= RULE_STRING ) )
            // InternalPlaylist.g:120:4: (lv_name_1_0= RULE_STRING )
            {
            // InternalPlaylist.g:120:4: (lv_name_1_0= RULE_STRING )
            // InternalPlaylist.g:121:5: lv_name_1_0= RULE_STRING
            {
            lv_name_1_0=(Token)match(input,RULE_STRING,FOLLOW_2); 

            					newLeafNode(lv_name_1_0, grammarAccess.getVideoAccess().getNameSTRINGTerminalRuleCall_1_0());
