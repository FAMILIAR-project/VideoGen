...
public class PlaylistPackageImpl extends EPackageImpl implements PlaylistPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getMediaFile_Duration(), ecorePackage.getEInt(), "duration", null, 0, 1, MediaFile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
