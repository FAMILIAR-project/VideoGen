 ...
 * @generated
 */
public class VideogenPlaylistSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case VideogenPlaylistPackage.PLAYLIST: {
				Playlist playlist = (Playlist)theEObject;
				T result = casePlaylist(playlist);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case VideogenPlaylistPackage.MEDIA_FILE: {
