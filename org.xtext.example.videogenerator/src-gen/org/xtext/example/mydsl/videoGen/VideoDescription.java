 ...
 *   <li>{@link org.xtext.example.mydsl.videoGen.VideoDescription#getTextIncrust <em>Text Incrust</em>}</li>
...
public interface VideoDescription extends EObject
{
  ...
  /**
   * Returns the value of the '<em><b>Text Incrust</b></em>' attribute.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Text Incrust</em>' attribute isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Text Incrust</em>' attribute.
   * @see #setTextIncrust(String)
   * @see org.xtext.example.mydsl.videoGen.VideoGenPackage#getVideoDescription_TextIncrust()
   * @model
   * @generated
   */
  String getTextIncrust();

  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.videoGen.VideoDescription#getTextIncrust <em>Text Incrust</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Text Incrust</em>' attribute.
   * @see #getTextIncrust()
   * @generated
   */
  void setTextIncrust(String value);
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.videoGen.VideoDescription#getFilter <em>Filter</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
