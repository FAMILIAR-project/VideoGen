...
public interface VideoGenPackage extends EPackage
{
   ...
   * @ordered
   */
  int VIDEO_DESCRIPTION__TEXT_INCRUST = 4;
   ...
   * @ordered
   */
  int VIDEO_DESCRIPTION__SUBTITLE = 7;
   ...
   * @ordered
   */
  int VIDEO_DESCRIPTION__FILTER = 9;
   ...
   * @ordered
   */
  int VIDEO_DESCRIPTION_FEATURE_COUNT = 10;
