...
public class VideoGenGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class VideoDescriptionElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cFilterSTRINGTerminalRuleCall_3_4_1_0 = (RuleCall)cFilterAssignment_3_4_1.eContents().get(0);
		private final Group cGroup_3_5 = (Group)cGroup_3.eContents().get(5);
		private final Keyword cSizeKeyword_3_5_0 = (Keyword)cGroup_3_5.eContents().get(0);
		private final Assignment cSizeAssignment_3_5_1 = (Assignment)cGroup_3_5.eContents().get(1);
		private final RuleCall cSizeINTTerminalRuleCall_3_5_1_0 = (RuleCall)cSizeAssignment_3_5_1.eContents().get(0);
		...
		//	('textIncrust' textIncrust=STRING)? ('filter' filter=STRING)? ('size' size=INT)? ('description' description=STRING)?
		//	RIGHT_BRACKET)?;
		@Override public ParserRule getRule() { return rule; }
		...
		//(LEFT_BRACKET ('duration' duration=INT)? ('probability' probability=INT)? ('textIncrust' textIncrust=STRING)? ('filter'
		//filter=STRING)? ('size' size=INT)? ('description' description=STRING)? RIGHT_BRACKET)?
		public Group getGroup_3() { return cGroup_3; }
		...
		//STRING
		public RuleCall getFilterSTRINGTerminalRuleCall_3_4_1_0() { return cFilterSTRINGTerminalRuleCall_3_4_1_0; }

		//('size' size=INT)?
		public Group getGroup_3_5() { return cGroup_3_5; }

		//'size'
		public Keyword getSizeKeyword_3_5_0() { return cSizeKeyword_3_5_0; }

		//size=INT
		public Assignment getSizeAssignment_3_5_1() { return cSizeAssignment_3_5_1; }

		//INT
		public RuleCall getSizeINTTerminalRuleCall_3_5_1_0() { return cSizeINTTerminalRuleCall_3_5_1_0; }
