package fr.istic.idm.web.websocket;

import fr.istic.idm.security.SecurityUtils;
import fr.istic.idm.web.websocket.dto.ActivityDTO;
...
import static fr.istic.idm.config.WebsocketConfiguration.IP_ADDRESS;
