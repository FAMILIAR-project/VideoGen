...
import fr.istic.idm.VideoGenWebSiteApp;
import fr.istic.idm.config.audit.AuditEventConverter;
import fr.istic.idm.domain.PersistentAuditEvent;
import fr.istic.idm.repository.PersistenceAuditEventRepository;
import fr.istic.idm.service.AuditEventService;
...
@SpringBootTest(classes = VideoGenWebSiteApp.class)
@Transactional
