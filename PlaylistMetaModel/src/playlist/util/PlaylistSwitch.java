...
public class PlaylistSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PlaylistPackage.ENTRY: {
				Entry entry = (Entry)theEObject;
				T result = caseEntry(entry);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PlaylistPackage.COMMENT: {
				Comment comment = (Comment)theEObject;
				T result = caseComment(comment);
				if (result == null) result = caseEntry(comment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PlaylistPackage.FILE: {
				File file = (File)theEObject;
				T result = caseFile(file);
				if (result == null) result = caseEntry(file);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PlaylistPackage.META_DATA: {
