...
public class PlaylistPackageImpl extends EPackageImpl implements PlaylistPackage {
	 ...
	 * @generated
	 */
	public EReference getPlaylist_Content() {
	 ...
	 * @generated
	 */
	public EReference getFile_Metadata() {
	 ...
	 * @generated
	 */
	public EAttribute getMetaData_Duree() {
	 ...
	 * @generated
	 */
	public EAttribute getMetaData_Details() {
	...
	public void createPackageContents() {
		...
		createEReference(playlistEClass, PLAYLIST__CONTENT);
		...
		createEAttribute(metaDataEClass, META_DATA__DUREE);
		createEAttribute(metaDataEClass, META_DATA__DETAILS);
	}
	...
	public void initializePackageContents() {
		...
		commentEClass.getESuperTypes().add(this.getEntry());
		...
		initEReference(getPlaylist_Content(), this.getEntry(), null, "content", null, 0, -1, Playlist.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getMetaData_Duree(), ecorePackage.getEInt(), "duree", null, 0, 1, MetaData.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMetaData_Details(), ecorePackage.getEString(), "details", null, 0, 1, MetaData.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
