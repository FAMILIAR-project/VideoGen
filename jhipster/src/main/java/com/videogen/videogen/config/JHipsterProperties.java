package com.videogen.videogen.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "videogen@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "videogen API";

        private String description = "videogen API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "videogen";
