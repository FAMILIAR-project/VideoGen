...
public interface PlaylistPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link playlist.Content <em>Content</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see playlist.Content
	 * @see playlist.impl.PlaylistPackageImpl#getContent()
	 * @generated
	 */
	int CONTENT = 1;
	 ...
	 * @ordered
	 */
	int COMMENT__COMMENT = CONTENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int VIDEO__PATH = CONTENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int VIDEO_FEATURE_COUNT = CONTENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int VIDEO_OPERATION_COUNT = CONTENT_OPERATION_COUNT + 0;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link playlist.Playlist#getContents <em>Contents</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Contents</em>'.
	 * @see playlist.Playlist#getContents()
	 * @see #getPlaylist()
	 * @generated
	 */
	EReference getPlaylist_Contents();

	/**
	 * Returns the meta object for class '{@link playlist.Content <em>Content</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the attribute '{@link playlist.Comment#getComment <em>Comment</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Comment</em>'.
	 * @see playlist.Comment#getComment()
	 * @see #getComment()
	 * @generated
	 */
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference PLAYLIST__CONTENTS = eINSTANCE.getPlaylist_Contents();

		/**
		 * The meta object literal for the '{@link playlist.Content <em>Content</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see playlist.Content
		 * @see playlist.impl.PlaylistPackageImpl#getContent()
